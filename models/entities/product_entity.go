...
type Product struct {
	Id            uint      `gorm:"column:id;type:BIGINT UNSIGNED;primaryKey;autoIncrement"`
	...
	CategoryId    uint      `gorm:"column:category_id;type:BIGINT;not null;index:IDX_category_id"`
